...
//                    }
//                    // 保留本次oplog的ts读取时间
//                    metadataOplog.getQueueOfOplog().put(assemblyDocument(changeEvent));
...
//
//
//    private Document assemblyDocument(ChangeStreamDocument<Document> streamDocument) {
//        Document document = new Document();
//        if (streamDocument.getOperationType().getValue().equals("insert")) {
//
//
//        }
//
